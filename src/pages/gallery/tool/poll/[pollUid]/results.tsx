'use client';
// pages/gallery/tool/poll/[pollUid]/results.tsx
// /gallery/poll/[pollUid]/results から /gallery/tool/poll/[pollUid]/results に移動済み
import {
  Accordion,
  AccordionButton,
  AccordionIcon,
    ...
    return (
      <>
        <GalleryMeta
          ...
          ogUrl={`/gallery/tool/poll/${pollUid?.toString() || ''}`}
        />
  ...
  return (
    <>
      <GalleryMeta
        ...
        ogUrl={`/gallery/tool/poll/${String(data.pollUid)}/results`}
      />
      <SecondHeader isHeaderHidden={isHeaderHidden} title="Gallery" />
      <SectionWrapper>
