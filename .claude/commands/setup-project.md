...
1. `docs/ideas/` 内のマークダウンファイルを**全て**読む
2. 内容を理解し、PRD作成の参考にする
   - ファイル名に機能名が入っている（例: `flowmusic.md`, `ChordRunner.md`）
   - 複数ファイルある場合は全て読んで統合的に理解する
