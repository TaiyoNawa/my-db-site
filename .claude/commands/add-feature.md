...
**引数:** 機能名 (例: `/add-feature ES文字数カウンター`)
...
3. 特に `src/features/gallery/tool/` 配下の既存ツール実装を参照し、同じ構造に従う。
...
- ステップ7: `test`, `lint`, `build` の全てのコマンドがエラーなく成功する。
